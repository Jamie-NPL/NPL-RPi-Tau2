...
#define __PVGUILIB_H__
		...
		#else
			#ifdef WIN32
				#pragma message ( "Warning: Your compiler is not officially supported by the eBUS SDK. Currently supported compiler versions on Windows include Visual C++ 10 2010 to Visual C++ 14 2015." )
			#endif //WIN32
