...
#ifndef __PV_SYSTEMLIB_H__
#define __PV_SYSTEMLIB_H__

#ifdef PV_SYSTEM_EXPORTS
    ...
    #pragma comment( lib, "PvSystem" PT_SUFFIX_64 PT_SUFFIX_HYPHEN PT_SUFFIX_STATIC PT_SUFFIX_DEBUG ".lib" )
