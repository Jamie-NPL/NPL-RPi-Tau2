...
#define __SIMPLEIMAGINGLIB_H__
    ...
    #pragma comment( lib, "SimpleImagingLib" PT_SUFFIX_64 PT_SUFFIX_HYPHEN PT_SUFFIX_STATIC PT_SUFFIX_DEBUG ".lib" )
...
#endif // SIMPLEIMAGINGLIB_EXPORTS


#endif // __SIMPLEIMAGINGLIB_H__
