...
#define __PVCAMERABRIDGELIB_H__
    ...
    #pragma comment( lib, "PvCameraBridge" PT_SUFFIX_64 PT_SUFFIX_HYPHEN PT_SUFFIX_STATIC PT_SUFFIX_DEBUG ".lib" )
...
#endif // PV_CAMERABRIDGE_EXPORTS


#endif // __PVCAMERABRIDGELIB_H__
